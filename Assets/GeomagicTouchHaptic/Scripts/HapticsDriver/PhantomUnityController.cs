...
public class PhantomUnityController
{
    ...
    public uint InitDevice(string deviceName)
    {
        ...
        //string modelType = HdAPI.HdAPIGetString(HdAPI.ParameterName.HdAPI_DEVICE_MODEL_TYPE);
 ...
 /*       // ON : the standard is to generate a force
    ...
    public Vector3 GetPosition()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_CURRENT_POSITION, position);
    ...
    {
        double[] position = new double[3] { 0, 0, 0 };
        HdAPI.hdSetDoublev(HdAPI.ParameterName.HD_CURRENT_POSITION, position);
    }
    ...
    public Vector3 GetVelocity()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_CURRENT_VELOCITY, velocity);
    ...
    public Vector3 GetTipPosition()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_CURRENT_POSITION, position);
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_CURRENT_TRANSFORM, matrix);
    ...
    //		HdAPI.HdAPIGetDoublev(HdAPI.ParameterName.HdAPI_CURRENT_GIMBAL_ANGLES, gimbals);
    ...
    public Quaternion GetRotation()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_CURRENT_TRANSFORM, matrixRotation);
        //
    ...
    public Buttons GetButton()
    {
        ...
        HdAPI.hdGetIntegerv(HdAPI.ParameterName.HD_CURRENT_BUTTONS, button);
    ...
    public double GetInstantaneousUpdateRate()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_INSTANTANEOUS_UPDATE_RATE, rate);
        return rate[0];
    }
    ...
    public double GetForceLimit()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_NOMINAL_MAX_FORCE, maxForce);
        return maxForce[0];
    }
    ...
    public double GetContinuousForceLimit()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_NOMINAL_MAX_CONTINUOUS_FORCE, maxForce);
        return maxForce[0];
    }
    ...
    public void SetForce(Vector3 force)
    {
        ...
        HdAPI.hdSetDoublev(HdAPI.ParameterName.HD_CURRENT_FORCE, forceArray);
    }
    ...
    private void LoadWorkspaceLimit()
    {
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_MAX_WORKSPACE_DIMENSIONS, val);
        ...
        HdAPI.hdGetDoublev(HdAPI.ParameterName.HD_USABLE_WORKSPACE_DIMENSIONS, val);
        ...
        HdAPI.hdGetFloatv(HdAPI.ParameterName.HD_TABLETOP_OFFSET, offset);
