...
/// </summary>
public class TwoHapticsCoulombForceAttraction2 : MonoBehaviour
{
    //---------------------------------------------------------------------------
    // CLASS INSTANCE
    //---------------------------------------------------------------------------
    ...
    /// </summary>
	public static TwoHapticsCoulombForceAttraction2 instance;
    ...
    private void Update()
    {
        ...
        else 
        {
            if (createLine)
            {
                ...
                lineRenderer.startWidth = 0.01f; // Largeur de début de la ligne
                lineRenderer.endWidth = 0.01f; // Largeur de fin de la ligne
                previousPosition = point.transform.position;
